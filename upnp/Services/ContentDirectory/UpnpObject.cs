...
namespace upnp.Services.ContentDirectory
{
    public class UpnpObject
    {
        ...
        {
            UpnpResource bestResource = null;
        ...
        readonly List<UpnpResource> _resourceFiles = new List<UpnpResource>();
        ...
        readonly List<string> _rights = new List<string>();
        ...
        protected void ReadObjectAttributes(XmlReader reader)
        {
            ...
            if (!string.IsNullOrEmpty(reader.GetAttribute("restricted")))
            {
                Restricted = InnerTextToBoolean(reader.GetAttribute("restricted"));
            }
